...
const baseFontSize = '18px'; // The base font size in pixels, defaults to 16px.

const goldenRatio = 1.618;
const baseLineHeight = goldenRatio; // The base line height using the css unitless number, defaults to 1.5.
const scaleRatio = goldenRatio * 2; // The “scale ratio” for the theme. This value is the ratio between the h1 font size and the baseFontSize. So if the scale ratio is 2 and the baseFontSize is 16px then the h1 font size is 32px.
const blockMarginBottom = 0; // Specify the default margin-bottom for block elements. Defaults to one “rhythm unit” (i.e. the height of the base line height).
